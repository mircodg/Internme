...
export function CardAndHover() {
  return (
    ...
    >
      ...
      >
        <div className="flex flex-grow flex-row justify-between items-end p-4">
          <div>
          ...
          <div className="p-6">
            ...
            >
              ...
              <p className="text-zinc-500">
                ...
                the “EB 27” double-arm desk lamp in 1925, handcrafting it from
